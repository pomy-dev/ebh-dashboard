        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 text-black focus:ring-blue-500 focus:border-transparent transition-all ${errors.message ? 'border-red-500' : 'border-gray-300'
                }`}
